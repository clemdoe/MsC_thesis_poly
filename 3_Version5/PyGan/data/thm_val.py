...
print("Thm object : ", Thm)
for i in Thm.keys():
  print("Thm keys: ", i)
  print(f"Th[{i}]: ", Thm[i])

#print("Fmap object : ", Fmap.keys())
#print("Thm HISTORY DATA : ", Thm["HISTORY-DATA"]['TIMESTEP0000']['CHANNEL'])
#print("Thm HISTORY DATA : ", Thm["HISTORY-DATA"]['TIMESTEP0000']['TIME'].keys())
